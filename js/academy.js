...
window.handleGoogleSignIn = async (response) => {
  try {
    const loginMessage = document.getElementById('googleLoginMessage') || document.getElementById('loginMessage');
    if (loginMessage) {
      loginMessage.textContent = 'Authenticating...';
      loginMessage.style.color = '#fff';
    }
    
    // Close modal immediately so it doesn't block the phone modal or look stuck
